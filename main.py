...
#Declarando uma variavel Janelas com o Tkinter
janela=tk.Tk()
janela.title('Cotação Moeda')
#Configurando as linhas e colunas da janela
janela.rowconfigure(0,weight=1)
janela.columnconfigure([0,1],weight=1)
#Inserindo o primeiro labe, declarando sua cor de fundo e das letras, e tamanho
